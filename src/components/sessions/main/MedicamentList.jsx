    ...
    <Paper elevation={0} className="p-4 mt-4 border border-gray-300 rounded-lg">
      ...
      {medicaments.map((medicament) => (
        <Box
          ...
          sx={{ backgroundColor: editingId === medicament.DWAID ? "rgba(0, 0, 0, 0.04)" : "transparent" }}
        >
          <Stack direction="row" justifyContent="space-between" alignItems="flex-start">
            <Typography variant="subtitle1" fontWeight={500}>
              {medicament.NameDWA} ({medicament.unit})
            </Typography>
            <Button
              startIcon={<Edit />}
              size="small"
              onClick={() => setEditingId(editingId === medicament.DWAID ? null : medicament.DWAID)}
          ...
          {editingId === medicament.DWAID ? (
            <Stack spacing={2} className="mt-3">
              <TextField
                ...
                onChange={(e) => handleUpdateMedicament(medicament.DWAID, "instructions", e.target.value)}
              ...
              <Stack direction="row" spacing={2}>
                <TextField
                  ...
                  onChange={(e) => handleUpdateMedicament(medicament.DWAID, "posologie", e.target.value)}
                  sx={{ width: "30%" }}
                />
                ...
                <TextField
                  ...
                  onChange={(e) => handleUpdateMedicament(medicament.DWAID, "voie", e.target.value)}
                  sx={{ width: "30%" }}
                />
                ...
                <TextField
                  ...
                  onChange={(e) => handleUpdateMedicament(medicament.DWAID, "quantity", parseInt(e.target.value, 10))}
                  inputProps={{ min: 1 }}
                  sx={{ width: "30%" }}
                />
                ...
                <FormControl sx={{ width: "70%" }}>
                  ...
                  <Select
                    ...
                    label="Unit"
                    onChange={(e) => handleUpdateMedicament(medicament.DWAID, "unit", e.target.value)}
                  >
